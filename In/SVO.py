...
if __name__ == "__main__":
    ...
    datapath = 'Leti/indoor_forward_11_snapdragon/img'
    ...
    leftImagePath = datapath + '/image_0_'
    rightImagePath = datapath + '/image_1_'
    ...
    for frm in range(startFrame+1, endFrame+1):
        ...
        imgPath = leftImagePath + str(frm-1)+ '.png';
        ImT1_L = cv2.imread(imgPath, 0)    #0 flag returns a grayscale image

        imgPath = rightImagePath +  str(frm-1) + '.png';
        ImT1_R = cv2.imread(imgPath, 0)

        imgPath = leftImagePath +  str(frm)+ '.png';
        ImT2_L = cv2.imread(imgPath, 0)

        imgPath = rightImagePath + str(frm) + '.png';
